...
-- Metodo posicional -- Parametros na ordem que eles foram definidos na procedure
SET SERVEROUT ON
SET VERIFY OFF
DECLARE
...
-- Metodo Nomeado -- Parametros com nomeação dos parametros da procedure, pode passar em qualquer ordem
